...
url(r'package/id/(?P<id>\d{1,10})/(?P<emitter_format>[^/]*)/$', redirect),
url(r'package/(?P<name>[^/]*)/(?P<generalquery>latest)/(?P<emitter_format>[^/]*)/$', redirect),
url(r'package/(?P<name>[^/]*)/(?P<generalquery>all)/(?P<emitter_format>[^/]*)/$', redirect),
url(r'package/(?P<name>[^/]*)/(?P<version>[^/]*)/(?P<emitter_format>[^/]*)/$', package),
# Shows all versions for certain package
